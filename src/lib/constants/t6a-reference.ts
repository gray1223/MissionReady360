...
export const MNEMONICS = {
  BPWANTFACTS: {
    name: "BPWANTFACTS",
    description: "Initial information gathering for standup EP",
    items: [
      { letter: "B", meaning: "Boldface" },
      { letter: "P", meaning: "Placement (position, altitude, airspeed)" },
      { letter: "W", meaning: "Weather" },
      { letter: "A", meaning: "ATIS/NOTAMs" },
      { letter: "N", meaning: "Nearest suitable airfield" },
      { letter: "T", meaning: "Terrain" },
      { letter: "F", meaning: "Fuel state" },
      { letter: "A", meaning: "Airframe limitations" },
      { letter: "C", meaning: "Crew/Cockpit (solo/dual, CRM)" },
      { letter: "T", meaning: "Time available" },
      { letter: "S", meaning: "SIFs/Squawks" },
    ],
  },
  MATSLACAP: {
    name: "MATSLACAP",
